...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({ container, slide, nextArrow, prevArrow, totalCounter, currrenCounter, wrapper, field }) {
  const slides = document.querySelectorAll(slide),
    slider = document.querySelector(container),
    nextBtn = document.querySelector(nextArrow),
    prevBtn = document.querySelector(prevArrow),
    total = document.querySelector(totalCounter),
    current = document.querySelector(currrenCounter),
  ...
  function changeCurrentIndex(slideIndex) {
    current.textContent = slides.length < 10 ? `0${slideIndex}` : slideIndex;
  }

  function changeDotsOpacity(slideIndex) {
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // Timer
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])(".timer", "2026-09-21");
